...
hold off
%set working dir to xhtml exporter home
%set options for figure2xhtml(), so that filename of output is
%PLATEBARCODE_WELL, also set dir for export to user defined dir 
%also user defined options for grid, axes name etc
 figure2xhtml()
 %reset working dir to the temp dir set by KNIME
